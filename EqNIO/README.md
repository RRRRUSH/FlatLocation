...
```bash
python3 TLIO-master/src/main_net.py --mode train --root_dir /data/for_llio --out_dir /home/user/HaozhanLi/EqNIO/models/TLIO_O2_0407 --batch_size 1024 --epochs 200 --arch eq_o2_frame_fullCov_2vec_2deep --dataset_style ram
```
...
# EKF 推理
```bash
python E:\HaozhanLi\Project\FlatLoc\EqNIO\TLIO-master\src\main_filter.py --root_dir E:\HaozhanLi\Project\FlatLoc\EqNIO\data\040h1 --out_dir E:\HaozhanLi\Project\FlatLoc\EqNIO\output --model_path E:\HaozhanLi\Project\FlatLoc\EqNIO\models\TLIO_O2_openbody\checkpoints\checkpoint_43.pt --model_param_path E:\HaozhanLi\Project\FlatLoc\EqNIO\models\TLIO_O2_openbody\parameters.json --save_as_npy
```
