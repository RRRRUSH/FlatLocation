...
from server.models.model_resnet import *
...
def get_model(model_path):
    ...
    model = ResNet1D(input_channel, output_channel, BasicBlock1D, [2, 2, 2, 2],base_plane=64, output_block=FCOutputModule, kernel_size=3,**fc_config)
