...
class Gui():
    ...
    def _get_solution_from_gui(self):
        ...
        print('\tscale ', v_scale, '\n')
        print('\tbias ', v_bias, '\n')
        self.refined_traj,self.refined_yaw = self.functions['pos_prior'].func.get_modified_trajectory(v_pos, v_yaw, v_bias, v_noise,
                                                                                     v_scale)
...
if __name__ == '__main__':
    ...
    for data_info in data_list:
        ...
        plt.close('all')
        print("args 11", args.scale_interval)
        if args.no_gui:
