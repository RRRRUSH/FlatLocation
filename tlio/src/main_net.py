...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--root_dir", type=str, 
        default=r"E:\HaozhanLi\Project\FlatLoc\tlio\data\train\vr_step_20250311", help="Path to data directory"
    )
    parser.add_argument("--out_dir", type=str, default=r"E:\HaozhanLi\Project\FlatLoc\tlio\models\test")
    ...
    parser.add_argument("--dataset_style", type=str, default="ram",
